...
metrics_mapping = {
    ...
    'set_root_sec_ctx_count': Gauge('smb2_set_root_sec_ctx_count', 'Number of set root sec ctx count'),
    ...
    'syscall_opendir_time' : Gauge('smb2_syscall_opendir_time', 'Time spent in opendir system calls'),
    'syscall_fdopendir_count' : Gauge('smb2_syscall_fdopendir_count', 'Count of fdopendir system calls'),
    'syscall_fdopendir_time' : Gauge('smb2_syscall_fdopendir_time', 'Time spent in fdopendir system calls'),
    'syscall_readdir_count' : Gauge('smb2_syscall_readdir_count', 'Count of readdir system calls'),
    'syscall_readdir_time' : Gauge('smb2_syscall_readdir_time', 'Time spent in readdir system calls'),
    'syscall_seekdir_count' : Gauge('smb2_syscall_seekdir_count', 'Count of seekdir system calls'),
    'syscall_seekdir_time' : Gauge('smb2_syscall_seekdir_time', 'Time spent in seekdir system calls'),
    'syscall_telldir_count' : Gauge('smb2_syscall_telldir_count', 'Count of telldir system calls'),
    'syscall_telldir_time' : Gauge('smb2_syscall_telldir_time', 'Time spent in telldir system calls'),
    'syscall_rewinddir_count' : Gauge('smb2_syscall_rewinddir_count', 'Count of rewinddir system calls'),
    'syscall_rewinddir_time' : Gauge('smb2_syscall_rewinddir_time', 'Time spent in rewinddir system calls'),
    'syscall_mkdir_count' : Gauge('smb2_syscall_mkdir_count', 'Count of mkdir system calls'),
    'syscall_mkdir_time' : Gauge('smb2_syscall_mkdir_time', 'Time spent in mkdir system calls'),
    'syscall_rmdir_count' : Gauge('smb2_syscall_rmdir_count', 'Count of rmdir system calls'),
    'syscall_rmdir_time' : Gauge('smb2_syscall_rmdir_time', 'Time spent in rmdir system calls'),
    'syscall_closedir_count': Gauge('smb2_syscall_closedir_count', 'Count of closedir system calls'),
    'syscall_closedir_time' : Gauge('smb2_syscall_closedir_time', 'Time spent in closedir system calls'),
    'syscall_open_count' : Gauge('smb2_syscall_open_count', 'Count of open system calls'),
    'syscall_open_time' : Gauge('smb2_syscall_open_time', 'Time spent in open system calls'),
    'syscall_createfile_count' : Gauge('smb2_syscall_createfile_count', 'Count of createfile system calls'),
    'syscall_createfile_time' : Gauge('smb2_syscall_createfile_time', 'Time spent in createfile system calls'),
    ...
    'syscall_asys_pread_count' : Gauge('smb2_syscall_asys_pread_count', 'Count of asynchronous pread system calls'),
    'syscall_asys_pread_time' : Gauge('smb2_syscall_asys_pread_time', 'Time spent in asynchronous pread system calls'),
    'syscall_asys_pread_idle' : Gauge('smb2_syscall_asys_pread_idle', 'Idle time spent in asynchronous pread system calls'),
    'syscall_asys_pread_bytes' : Gauge('smb2_syscall_asys_pread_bytes', 'Bytes read in asynchronous pread system calls'),
    'syscall_pwrite_count' : Gauge('smb2_syscall_pwrite_count', 'Count of pwrite system calls'),
    'syscall_pwrite_time' : Gauge('smb2_syscall_pwrite_time', 'Count of pwrite system time'),
    'syscall_pwrite_idle' : Gauge('smb2_syscall_pwrite_idle', 'Idle time spent in pwrite system calls'),
    'syscall_pwrite_bytes': Gauge('smb2_syscall_pwrite_bytes', 'Bytest wirte in pwirte system calls'),
    'syscall_asys_pwrite_count': Gauge('smb2_syscall_asys_pwrite_count', 'Count of asynchronous pwrite system calls'),
    'syscall_asys_pwrite_time': Gauge('smb2_syscall_asys_pwrite_time', 'Time spent in asynchronous pwrite system calls'),
    'syscall_asys_pwrite_idle': Gauge('smb2_syscall_asys_pwrite_idle', 'Idle time spent in asynchronus pwrite system calls'),
    'syscall_asys_pwrite_bytes': Gauge('smb2_syscall_asys_pwrite_bytes', 'Bytes write in asynchronous pwrite system calls'),
    ...
    'syscall_sendfile_count': Gauge('smb2_syscall_sendfile_count', 'Number of sendfile system calls'),
    'syscall_sendfile_time': Gauge('smb2_syscall_sendfile_time', 'Time spent in sendfile system calls'),
    'syscall_sendfile_idle': Gauge('smb2_syscall_sendfile_idle', 'Idle time between sendfile system calls'),
    'syscall_sendfile_bytes': Gauge('smb2_syscall_sendfile_bytes', 'Number of bytes sent by sendfile system calls'),
    'syscall_recvfile_count': Gauge('smb2_syscall_recvfile_count', 'Number of recvfile system calls'),
    'syscall_recvfile_time': Gauge('smb2_syscall_recvfile_time', 'Time spent in recvfile system calls'),
    'syscall_recvfile_idle': Gauge('smb2_syscall_recvfile_idle', 'Idle time between recvfile system calls'),
    'syscall_recvfile_bytes': Gauge('smb2_syscall_recvfile_bytes', 'Number of bytes received by recvfile system calls'),
    'syscall_rename_count': Gauge('smb2_syscall_rename_count', 'Number of rename system calls'),
    'syscall_rename_time': Gauge('smb_syscall_rename_time', 'Time spent in rename system calls'),
    'syscall_rename_at_count' : Gauge('smb2_syscall_rename_at_count', 'Number of rename_at system calls'),
    'syscall_rename_at_time' : Gauge('smb2_syscall_rename_at_time', 'Total time spent in rename_at system calls'),
    'syscall_asys_fsync_count' : Gauge('smb2_syscall_asys_fsync_count', 'Number of asys_fsync system calls'),
    'syscall_asys_fsync_time' : Gauge('smb2_syscall_asys_fsync_time', 'Total time spent in asys_fsync system calls'),
    'syscall_stat_count' : Gauge('smb2_syscall_stat_count', 'Number of stat system calls'),
    'syscall_stat_time' : Gauge('smb2_syscall_stat_time', 'Total time spent in stat system calls'),
    'syscall_fstat_count' : Gauge('smb2_syscall_fstat_count', 'Number of fstat system calls'),
    'syscall_fstat_time' : Gauge('smb2_syscall_fstat_time', 'Total time spent in fstat system calls'),
    'syscall_lstat_count' : Gauge('smb2_syscall_lstat_count', 'Number of lstat system calls'),
    'syscall_lstat_time' : Gauge('smb2_syscall_lstat_time', 'Total time spent in lstat system calls'),
    'syscall_get_alloc_size_count' : Gauge('smb2_syscall_get_alloc_size_count', 'Number of get_alloc_size system calls'),
    'syscall_get_alloc_size_time' : Gauge('smb2_syscall_get_alloc_size_time', 'Total time spent in get_alloc_size system calls'),
    ...
    'syscall_ftruncate_count' : Gauge('smb2_syscall_ftruncate_count', 'Number of ftruncate system calls'),
    'syscall_ftruncate_time' : Gauge('smb2_syscall_ftruncate_time', 'Time spent in ftruncate system calls'),
    'syscall_fallocate_count' : Gauge('smb2_syscall_fallocate_count', 'Number of fallocate system calls'),
    'syscall_fallocate_time' : Gauge('smb2_syscall_fallocate_time', 'Time spent in fallocate system calls'),
    'syscall_fcntl_lock_count' : Gauge('smb2_syscall_fcntl_lock_count', 'Number of fcntl lock system calls'),
    'syscall_fcntl_lock_time' : Gauge('smb2_syscall_fcntl_lock_time', 'Time spent in fcntl lock system calls'),
    'syscall_kernel_flock_count' : Gauge('smb2_syscall_kernel_flock_count', 'Number of kernel flock system calls'),
    'syscall_kernel_flock_time' : Gauge('smb2_syscall_kernel_flock_time', 'Time spent in kernel flock system calls'),
    'syscall_linux_setlease_count' : Gauge('smb2_syscall_linux_setlease_count', 'Number of Linux setlease system calls'),
    'syscall_linux_setlease_time': Gauge('smb2_syscall_linux_setlease_time', 'Time spent in Linux setlease system calls'),
    'syscall_fcntl_getlock_count' : Gauge('smb2_syscall_fcntl_getlock_count', 'Number of fcntl getlock system calls'),
    'syscall_fcntl_getlock_time' : Gauge('smb2_syscall_fcntl_getlock_time', 'Time spent in fcntl getlock system calls'),
    'syscall_readlink_count' : Gauge('smb2_syscall_readlink_count', 'Number of readlink system calls'),
    'syscall_readlink_time' : Gauge('smb2_syscall_readlink_time', 'Time spent in readlink system calls'),
    'syscall_symlink_count' : Gauge('smb2_syscall_symlink_count', 'Number of symlink system calls'),
    'syscall_symlink_time' : Gauge('smb2_syscall_symlink_time', 'Time spent in symlink system calls'),
    'syscall_link_count' : Gauge('smb2_syscall_link_count', 'Number of link system calls'),
    ...
    'syscall_realpath_count' : Gauge('smb2_syscall_realpath_count', 'Number of realpath system calls'),
    'syscall_realpath_time' : Gauge('smb2_syscall_realpath_time', 'Time spent in realpath system calls'),
    'syscall_get_quota_count' : Gauge('smb2_syscall_get_quota_count', 'Number of get quota system calls'),
    'syscall_get_quota_time' : Gauge('smb2_syscall_get_quota_time', 'Time spent in get quota system calls'),
    'syscall_set_quota_count' : Gauge('smb2_syscall_set_quota_count', 'Number of set quota system calls'),
    'syscall_set_quota_time' : Gauge('smb2_syscall_set_quota_time', 'Time spent in set quota system calls'),
    'syscall_get_sd_count' : Gauge('smb2_syscall_get_sd_count', 'Number of get sd system calls'),
    'syscall_get_sd_time' : Gauge('smb2_syscall_get_sd_time', 'Time spent in get sd system calls'),
    ...
    'syscall_brl_lock_count' : Gauge('smb2_syscall_brl_lock_count', 'Number of brl lock system calls'),
    'syscall_brl_lock_time' : Gauge('smb2_syscall_brl_lock_time', 'Time spent in brl lock system calls'),
    'syscall_brl_unlock_count' : Gauge('smb2_syscall_brl_unlock_count', 'Number of brl unlock system calls'),
    'syscall_brl_unlock_time' : Gauge('smb2_syscall_brl_unlock_time', 'Time spent in brl unlock system calls'),
    'syscall_brl_cancel_count' : Gauge('smb2_syscall_brl_cancel_count', 'Number of brl cancel system calls'),
    'syscall_brl_cancel_time' : Gauge('smb2_syscall_brl_cancel_time', 'Time spent in brl cancel system calls'),
    ...
    'writecache_allocations_count' : Gauge('smb2_writecache_allocations_count', 'Number of times memory was allocated for write cache'),
    'writecache_deallocations_count' : Gauge('smb2_writecache_deallocations_count', 'Number of times memory was deallocated for write cache'),
    'writecache_cached_reads_count' : Gauge('smb2_writecache_cached_reads_count', 'Number of cached reads from write cache'),
    'writecache_total_writes_count' : Gauge('smb2_writecache_total_writes_count', 'Total number of writes to write cache'),
    'writecache_init_writes_count' : Gauge('smb2_writecache_init_writes_count', 'Number of writes to newly allocated write cache'),
    'writecache_abutted_writes_count' : Gauge('smb2_writecache_abutted_writes_count', 'Number of writes that abutted the end of write cache'),
    'writecache_non_oplock_writes_count' : Gauge('smb2_writecache_non_oplock_writes_count', 'Number of non-oplock writes to write cache'),
    'writecache_direct_writes_count' : Gauge('smb2_writecache_direct_writes_count', 'Number of direct writes to write cache'),
    'writecache_cached_writes_count' : Gauge('smb2_writecache_cached_writes_count', 'Number of cached writes to write cache'),
    'writecache_perfect_writes_count' : Gauge('smb2_writecache_perfect_writes_count', 'Number of writes to write cache that matched cache size'),
    'writecache_flush_reason_seek_count' : Gauge('smb2_writecache_flush_reason_seek_count', 'Number of write cache flushes due to seek operation'),
    'writecache_flush_reason_read_count' : Gauge('smb2_writecache_flush_reason_read_count', 'Number of write cache flushes due to read operation'),
    'writecache_flush_reason_readraw_count' : Gauge('smb2_writecache_flush_reason_readraw_count', 'Number of write cache flushes due to read raw operation'),
    'writecache_flush_reason_write_count' : Gauge('smb2_writecache_flush_reason_write_count', 'Number of write cache flushes due to write operation'),
    'writecache_flush_reason_oplock_count' : Gauge('smb2_writecache_flush_reason_oplock_count', 'Number of write cache flushes due to oplock break'),
    'writecache_flush_reason_close_count' : Gauge('smb2_writecache_flush_reason_close_count', 'Number of write cache flushes due to file close'),
    'writecache_flush_reason_sync_count' : Gauge('smb2_writecache_flush_reason_sync_count', 'Number of write cache flushes due to sync operation'),
    'writecache_flush_reason_sizechange_count' : Gauge('smb2_writecache_flush_reason_sizechange_count', 'Number of write cache flushes due to file size change'),
    ...
    'smbcheckpath_count' : Gauge('smb2_samba_smbcheckpath_count', 'Number of SMBcheckpath operations'),
    'smbcheckpath_time' : Gauge('smb2_samba_smbcheckpath_time', 'Time taken for SMBcheckpath operations'),
    ...
    'SMBwriteunlock_time' : Gauge('smb2SMBwriteunlock_time', 'Total time spent in SMBwriteunlock calls'),
    ...
    'SMBwritebraw_time' : Gauge('smb2_SMBwritebraw_time', 'The amount of time spent in SMBwritebraw (in seconds)'),
    'SMBwriteBmpx_count' : Gauge('smb2_SMBwriteBmpx_count', 'The number of SMBwriteBmpx calls'),
    'SMBwriteBmpx_time' : Gauge('smb2_SMBwriteBmpx_time', 'The amount of time spent in SMBwriteBmpx (in seconds)'),
    'SMBwriteBs_count' : Gauge('smb2_SMBwriteBs_count', 'The number of SMBwriteBs calls'),
    'SMBwriteBs_time' : Gauge('smb2_SMBwriteBs_time', 'The amount of time spent in SMBwriteBs (in seconds)'),
    'SMBwritec_count' : Gauge('smb2_SMBwritec_count', 'The number of SMBwritec calls'),
    'SMBwritec_time' : Gauge('smb2_SMBwritec_time', 'The amount of time spent in SMBwritec (in seconds)'),
    'SMBsetattrE_count' : Gauge('smb2_SMBsetattrE_count', 'The number of SMBsetattrE calls'),
    'SMBsetattrE_time' : Gauge('smb2_SMBsetattrE_time', 'The amount of time spent in SMBsetattrE (in seconds)'),
    'SMBgetattrE_count' : Gauge('smb2_SMBgetattrE_count', 'The number of SMBgetattrE calls'),
    'SMBgetattrE_time' : Gauge('smb2_SMBgetattrE_time', 'The amount of time spent in SMBgetattrE (in seconds)'),
    'SMBlockingX_count' : Gauge('smb2_SMBlockingX_count', 'The number of SMBlockingX calls'),
    'SMBlockingX_time' : Gauge('smb2_SMBlockingX_time', 'The amount of time spent in SMBlockingX (in seconds)'),
    'SMBtrans_count' : Gauge('smb2_SMBtrans_count', 'The number of SMBtrans calls'),
    'SMBtrans_time' : Gauge('smb2_SMBtrans_time', 'The amount of time spent in SMBtrans (in seconds)'),
    ...
    'Trans2_findnotifyfirst_count' : Gauge('smb2_Trans2_findnotifyfirst_count', 'Trans2_findnotifyfirst count'),
    'Trans2_findnotifyfirst_time' : Gauge('smb2_Trans2_findnotifyfirst_time', 'Trans2_findnotifyfirst time'),
    'Trans2_findnotifynext_count' : Gauge('smb2_Trans2_findnotifynext_count', 'Trans2_findnotifynext count'),
    'Trans2_findnotifynext_time' : Gauge('smb2_Trans2_findnotifynext_time', 'Trans2_findnotifynext time'),
    'Trans2_mkdir_count' : Gauge('smb2_Trans2_mkdir_count', 'Trans2_mkdir count'),
    'Trans2_mkdir_time' : Gauge('smb2_Trans2_mkdir_time', 'Trans2_mkdir time'),
    'Trans2_session_setup_count' : Gauge('smb2_Trans2_session_setup_count', 'Trans2_session_setup count'),
    'Trans2_session_setup_time' : Gauge('smb2_Trans2_session_setup_time', 'Trans2_session_setup time'),
    'Trans2_get_dfs_referral_count' : Gauge('smb2_Trans2_get_dfs_referral_count', 'Trans2_get_dfs_referral count'),
    'Trans2_get_dfs_referral_time' : Gauge('smb2_Trans2_get_dfs_referral_time', 'Trans2_get_dfs_referral time'),
    'Trans2_report_dfs_inconsistancy_count' : Gauge('smb2_Trans2_report_dfs_inconsistancy_count', 'Trans2_report_dfs_inconsistancy count'),
    'Trans2_report_dfs_inconsistancy_time' : Gauge('smb2_Trans2_report_dfs_inconsistancy_time', 'Trans2_report_dfs_inconsistancy time'),
    'NT_transact_create_count' : Gauge('NT_transact_create_count', 'NT transact create count'),
    'NT_transact_create_time' : Gauge('NT_transact_create_time', 'NT transact create time'),
    'NT_transact_ioctl_count' : Gauge('NT_transact_ioctl_count', 'NT transact ioctl count'),
    'NT_transact_ioctl_time' : Gauge('NT_transact_ioctl_time', 'NT transact ioctl time'),
    'NT_transact_set_security_desc_count' : Gauge('NT_transact_set_security_desc_count', 'NT transact set security desc count'),
    'NT_transact_set_security_desc_time' : Gauge('NT_transact_set_security_desc_time', 'NT transact set security desc time'),
    'NT_transact_notify_change_count' : Gauge('NT_transact_notify_change_count', 'NT transact notify change count'),
    'NT_transact_notify_change_time' : Gauge('NT_transact_notify_change_time', 'NT transact notify change time'),
    'NT_transact_rename_count' : Gauge('NT_transact_rename_count', 'NT transact rename count'),
    'NT_transact_rename_time' : Gauge('NT_transact_rename_time', 'NT transact rename time'),
    'NT_transact_query_security_desc_count' : Gauge('NT_transact_query_security_desc_count', 'NT transact query security desc count'),
    'NT_transact_query_security_desc_time' : Gauge('NT_transact_query_security_desc_time', 'NT transact query security desc time'),
    'NT_transact_get_user_quota_count' : Gauge('NT_transact_get_user_quota_count', 'NT transact get user quota count'),
    'NT_transact_get_user_quota_time' : Gauge('NT_transact_get_user_quota_time', 'NT transact get user quota time'),
    'NT_transact_set_user_quota_count' : Gauge('NT_transact_set_user_quota_count', 'NT transact set user quota count'),
    'NT_transact_set_user_quota_time' : Gauge('NT_transact_set_user_quota_time', 'NT transact set user quota time'),
    'smb2_negprot_count' : Gauge('smb2_negprot_count', 'Number of SMB2 negotiation protocol requests'),
    'smb2_negprot_time' : Gauge('smb2_negprot_time', 'Total time spent on SMB2 negotiation protocol requests'),
    'smb2_negprot_idle' : Gauge('smb2_negprot_idle', 'Total idle time during SMB2 negotiation protocol requests'),
    'smb2_negprot_inbytes' : Gauge('smb2_negprot_inbytes', 'Total input bytes received during SMB2 negotiation protocol requests'),
    'smb2_negprot_outbytes' : Gauge('smb2_negprot_outbytes', 'Total output bytes sent during SMB2 negotiation protocol requests'),
    'smb2_sesssetup_count' : Gauge('smb2_sesssetup_count', 'Number of SMB2 session setup requests'),
    'smb2_sesssetup_time' : Gauge('smb2_sesssetup_time', 'Total time spent on SMB2 session setup requests'),
    'smb2_sesssetup_idle': Gauge('smb2_sesssetup_idle', 'Total idle time during SMB2 session setup requests'),
    'smb2_sesssetup_inbytes' : Gauge('smb2_sesssetup_inbytes', 'Total input bytes received during SMB2 session setup requests'),
    'smb2_sesssetup_outbytes' : Gauge('smb2_sesssetup_outbytes', 'Total output bytes sent during SMB2 session setup requests'),
    'smb2_logoff_count' : Gauge('smb2_logoff_count', 'Number of SMB2 logoff requests'),
    'smb2_logoff_time' : Gauge('smb2_logoff_time', 'Total time spent on SMB2 logoff requests'),
    'smb2_logoff_idle' : Gauge('smb2_logoff_idle', 'Total idle time during SMB2 logoff requests'),
    'smb2_logoff_inbytes' : Gauge('smb2_logoff_inbytes', 'Total input bytes received during SMB2 logoff requests'),
    'smb2_logoff_outbytes' : Gauge('smb2_logoff_outbytes', 'Total output bytes sent during SMB2 logoff requests'),
    'smb2_tcon_count' : Gauge('smb2_tcon_count', 'Number of SMB2 tree connect requests'),
    'smb2_tcon_time' : Gauge('smb2_tcon_time', 'Total time spent on SMB2 tree connect requests'),
    'smb2_tcon_idle' : Gauge('smb2_tcon_idle', 'Total idle time during SMB2 tree connect requests'),
    'smb2_tcon_inbytes' : Gauge('smb2_tcon_inbytes', 'Total input bytes received during SMB2 tree connect requests'),
    'smb2_tcon_outbytes' : Gauge('smb2_tcon_outbytes', 'Total output bytes sent during SMB2 tree connect requests'),
    'smb2_tdis_count' : Gauge('smb2_tdis_count', 'Number of SMB2 tree disconnect requests'),
